        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="dashboard_student.php">Dashboard</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row text-white">
            ...
            <div class="col-9 scrollable-column">
                ...
                <div class="row mt-5">
                    ...
                    $id_number = $_SESSION['idNumberStudent'];
                    $sql = "SELECT * FROM auditing_logs_student WHERE student_id = '$id_number' ORDER BY time_logged_in DESC";
