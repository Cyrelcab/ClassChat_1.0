...
<body class="verification-body">
    <div class="container-verify">
        ...
        <form method="POST">
            ...
            <div>
                <button type="submit" class="btn-verify btn-primary-verify" id="submitBtn" name="btn-forgot-verify-employee">Verify</button>
            </div>
        </form>
        <small> If you didn't recieve a code!! <a href="resend_code_employee_forgot.php" style="color: white; font-weight: bold;">Resend</a></small>
