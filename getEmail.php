...
//function for getting the email of the employee
function getEmployeeEmailById($conn, $id_number)
{
    $query = "SELECT email FROM employee_table WHERE Employee_number = ?";
    $stmt = mysqli_prepare($conn, $query);
